...
export const mockEpisodes: Episode[] = [
  ...
  },
  {
    ...
    pubDate: new Date('2024-01-02').toISOString(),
    durationSec: 120,
    episodeImageUrl: 'https://via.placeholder.com/300x300/059669/ffffff?text=Test+Episode+2',
    localAudioPath: null,
    status: 'in_progress',
    lastPlayedAt: new Date('2024-01-02').toISOString(),
    lastPositionSec: 45,
  },
  {
    id: 3,
    ...
    pubDate: new Date('2024-01-03').toISOString(),
    durationSec: 180,
    episodeImageUrl: 'https://via.placeholder.com/300x300/DC2626/ffffff?text=Music+Test',
    localAudioPath: null,
    status: 'played',
    lastPlayedAt: new Date('2024-01-03').toISOString(),
    lastPositionSec: 180,
  }
];
