...
const LibraryView: React.FC = () => (
  <div className="p-6">
    ...
    <p className="text-gray-600 dark:text-gray-400">
      Your podcast library will appear here.
    </p>
  </div>
);
...
const TranscriptionsView: React.FC = () => (
  <div className="p-6">
    ...
    <p className="text-gray-600 dark:text-gray-400">
      Audio transcriptions will appear here.
    </p>
  </div>
);
...
const SettingsView: React.FC = () => {
  const [activeSection, setActiveSection] = React.useState<"transcript" | "ai">(
    "transcript",
  );
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        <div
          className={`${activeSection === "ai" ? "h-full flex flex-col" : ""} p-6`}
        >
      ...
      case "subscriptions":
        try {
          ...
          return (
            <div className="p-6">
              <h1>Subscriptions</h1>
              <p>Error loading subscription list: {String(error)}</p>
            </div>
          );
        }
      case "episodes":
