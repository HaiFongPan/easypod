...
export interface ParsedAiSummary
  extends Omit<EpisodeAiSummary, "tags" | "chapters"> {
  tagsArray: string[];
...
export interface SubmitOptions {
  ...
  // Speaker recognition options (unified interface)
  spkEnable?: boolean; // Enable speaker recognition
  spkNumberPredict?: number; // Predicted number of speakers (1-9)
}
